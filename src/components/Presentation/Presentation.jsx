...
export const Presentation = () => {
  return (
    ...
    aux gardiennes et gardiens de but d'Ille et Vilaine.</li>
            <li>Créée en septembre 2019 par Christophe REVEL, <span>elle répond à une problématique d'entrainement</span>
    rencontrée dans les clubs du district et par les goals du 35.</li>
