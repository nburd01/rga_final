    ...
    <div className='inscriptions'>
      ...
      <div className="container-large">
        ...
        <section className="PicTitle">
            ...
            <div className="HeroImage">
              <LazyLoadImage src={require('../../assets/img/galerie/webp/roazhon_goal_academy__gardien_de_but_flexibilite.jpg')} className="_HeroImage" alt="Roazhon Goal Academy gardien de but" loading="lazy"/>
            </div>
        </section>
        </div>
      </div>
      <section className="pageBody">
        ...
        <div className="illustration">
          <LazyLoadImage  src={SoccerPlayer} alt="Soccer player" loading="lazy"/>
        </div>
        <PDF/>
      </section>
    </div>
